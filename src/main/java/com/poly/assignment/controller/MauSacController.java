...
//        } else {
//            Page<MauSac> mauSacPage = PageUtils.createPage(mauSacService.findAll(status), page, pageSize);
...
//        if (result.hasErrors()) {
//            Page<MauSac> mauSacPage = PageUtils.createPage(mauSacService.findAll("all"), page, pageSize);
//            model.addAttribute("colors", mauSacPage.getContent());
//            model.addAttribute("currentPage", page);
//            model.addAttribute("pageSize", pageSize);
//            model.addAttribute("totalPages", mauSacPage.getTotalPages());

...
//        } else {
//            Page<KichThuoc> kichThuocPage = PageUtils.createPage(kichThuocService.findAll(status), page, pageSize);
...
//        if (result.hasErrors()) {
//            Page<KichThuoc> kichThuocPage = PageUtils.createPage(kichThuocService.findAll("all"), page, pageSize);
//            model.addAttribute("sizes", kichThuocPage.getContent());
//            model.addAttribute("currentPage", page);
//            model.addAttribute("pageSize", pageSize);
//            model.addAttribute("totalPages", kichThuocPage.getTotalPages());

...
//        } else {
//            Page<NhanVien> nhanVienPage = PageUtils.createPage(nhanVienService.findAll(status), page, pageSize);
...
//        if (result.hasErrors()) {
//            Page<NhanVien> nhanVienPage = PageUtils.createPage(nhanVienService.findAll("all"), page, pageSize);
//            model.addAttribute("employees", nhanVienPage.getContent());
//            model.addAttribute("currentPage", page);
//            model.addAttribute("pageSize", pageSize);
//            model.addAttribute("totalPages", nhanVienPage.getTotalPages());

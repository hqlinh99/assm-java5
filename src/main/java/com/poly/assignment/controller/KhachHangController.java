...
//        } else {
//            Page<KhachHang> khachHangPage = PageUtils.createPage(khachHangService.findAll(status), page, pageSize);
...
//        if (result.hasErrors()) {
//            Page<KhachHang> khachHangPage = PageUtils.createPage(khachHangService.findAll("all"), page, pageSize);
//            model.addAttribute("customers", khachHangPage.getContent());
//            model.addAttribute("currentPage", page);
//            model.addAttribute("pageSize", pageSize);
//            model.addAttribute("totalPages", khachHangPage.getTotalPages());

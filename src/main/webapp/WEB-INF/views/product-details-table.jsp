                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <form:form id="kt_account_profile_details_form"
                                       ...
                                       action="/product-${sanPham.id}/details/create?sanPham.id=${sanPham.id}&id=${sanPhamChiTiet.id}"
                                       method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Error-->
                                                <form:errors path="donGia" class="badge badge-light-danger"/>
                                                <!--end::Error-->
                                                <!--begin::Input-->
                            ...
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                ...
                                <div class="card-title">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <button onclick="location.href='/product-${sanPham.id}/details/table?key='+document.getElementById('search-input').value"
                                ...
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    <div class="w-100 mw-150px">
                                        ...
                                        <select class="form-select form-select-solid" data-control="select2"
                                                ...
                                                name="status"
                                                onchange="location.href='/product-${sanPham.id}/details/table?page=0&pageSize=${pageSize}&status='+this.value">

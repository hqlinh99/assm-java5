...
<html lang="en">
<head>
    <title>${kichThuoc.id != null ? "Chỉnh sửa kích thước " += kichThuoc.id : "Kích thước" }</title>
</head>
<body>
<!--begin::Main-->
                            ...
                            <form:form id="kt_account_profile_details_form"
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="required form-label">Size code</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Allow sizes to purchase sizes that are out
                                            of stock.
                                        </div>
                                        <!--end::Description-->
                                        <!--begin::Error-->
                        ...
                        <div class="card card-flush">
                                ...
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    <div class="w-100 mw-150px">
                                        ...
                                        <select class="form-select form-select-solid" data-control="select2"
                                                ...
                                                data-kt-ecommerce-size-filter="status">
                                            <option></option>
                                    ...
                                    <!--begin::Add size-->
                                    <a href="/sizes/table" class="btn btn-primary">Add
                                        Size</a>
                                    <!--end::Add size-->
                                </div>
                                <!--end::Card toolbar-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5"
                                       id="kt_ecommerce_sizes_table">
                                    <thead>
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                        <th class="w-10px pe-2">
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                       data-kt-check-target="#kt_ecommerce_sizes_table .form-check-input"
                                                       value="1"/>
                                            </div>
                                        </th>
                                        <th class="min-w-200px">Size</th>
                                        <th class="text-end min-w-100px">Size code</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-5">
                                                        <!--begin::Title-->
                                                        <a href="apps/ecommerce/catalog/edit-size.html"
                                                           class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                           data-kt-ecommerce-size-filter="size_name">${size.ten}</a>
                                                        <!--end::Title-->
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-end pe-0">
                                                <span class="fw-bold">${size.maKT}</span>
                                            </td>
                                            <td class="text-end pe-0" data-order="Scheduled">
                                                <!--begin::Badges-->
                                                <div class="badge ${size.trangThai ? "badge-light-primary" : "badge-light-danger"}">${size.trangThai ? "Active" : "Locked"}</div>
                                                <!--end::Badges-->
                                            </td>
                                            <td class="text-end">
                                                <a href="#"
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="/size/update?id=${size.id}"
                                                           class="menu-link px-3">Edit</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="/sizes/delete?id=${size.id}"
                                                           class="menu-link px-3"
                                                           data-kt-ecommerce-size-filter="delete_row">Delete</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                </div>
                                                <!--end::Menu-->

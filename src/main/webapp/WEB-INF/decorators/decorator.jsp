...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        ...
        <a href="../../demo1/dist/index.html">
            <img alt="Logo" src="/public/assets/media/logos/logo-1-dark.svg" class="h-25px logo"/>
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
...
<jsp:include page="//WEB-INF/components/cart-drawer.jsp"/>
...
<script src="/public/assets/js/custom/apps/ecommerce/catalog/products.js"></script>
...
<!--end::Javascript-->
<script>
    const kt_td_picker_localization = document.getElementById("kt_td_picker_localization");
